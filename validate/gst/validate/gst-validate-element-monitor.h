...
#define GST_VALIDATE_ELEMENT_MONITOR_ELEMENT_IS_MUXER(m)   (GST_VALIDATE_ELEMENT_MONITOR_CAST (m)->is_muxer)
#define GST_VALIDATE_ELEMENT_MONITOR_ELEMENT_IS_PARSER(m) (GST_VALIDATE_ELEMENT_MONITOR_CAST (m)->is_parser)
